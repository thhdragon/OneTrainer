...
class Krea2ModelLoader(
    ...
    def __load_safetensors(
        ...
        raise NotImplementedError("Loading of single file Krea2 models not supported. Use the diffusers model instead.")
...
Krea2LoRAModelLoader = make_lora_model_loader(
    model_spec_map={
        ModelType.KREA2: "resources/sd_model_spec/krea2-lora.json",
    },
...
Krea2FineTuneModelLoader = make_fine_tune_model_loader(
    model_spec_map={
        ModelType.KREA2: "resources/sd_model_spec/krea2.json",
    },
    model_class=Krea2Model,
    model_loader_class=Krea2ModelLoader,
    embedding_loader_class=None,
