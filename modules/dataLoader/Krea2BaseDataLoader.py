...
from modules.model.Krea2Model import PROMPT_MAX_LENGTH, Krea2Model
...
from mgds.pipelineModules.EncodeKrea2Text import EncodeKrea2Text
...
from mgds.pipelineModules.TokenizeKrea2 import TokenizeKrea2


@factory.register(BaseDataLoader, ModelType.KREA2)
class Krea2BaseDataLoader(
    BaseDataLoader,
    DataLoaderText2ImageMixin,
):
    def _preparation_modules(self, config: TrainConfig, model: Krea2Model):
    ...
    def _cache_modules(self, config: TrainConfig, model: Krea2Model, model_setup: BaseKrea2Setup):
    ...
    def _debug_modules(self, config: TrainConfig, model: Krea2Model):
